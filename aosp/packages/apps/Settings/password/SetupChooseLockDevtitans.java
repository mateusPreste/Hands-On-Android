 ...
 * those changes.
 */
public class SetupChooseLockDevtitans extends ChooseLockPattern {

    public static Intent modifyIntentForSetup(Context context, Intent chooseLockPatternIntent) {
        chooseLockPatternIntent.setClass(context, SetupChooseLockDevtitans.class);
        return chooseLockPatternIntent;
    }

    @Override
    protected boolean isValidFragment(String fragmentName) {
        return SetupChooseLockDevtitansFragment.class.getName().equals(fragmentName);
    }

    @Override
    /* package */ Class<? extends Fragment> getFragmentClass() {
        return SetupChooseLockDevtitansFragment.class;
    }
    ...
    public static class SetupChooseLockDevtitansFragment extends ChooseLockPatternFragment
