    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        private void updatePreferenceText() {
            if (mForFingerprint) {
                ...
                setPreferenceTitle(ScreenLockType.DEVTITANS,
                        R.string.fingerprint_unlock_set_unlock_pattern);
                ...
                setPreferenceTitle(ScreenLockType.DEVTITANS,
                        getBiometricsPreferenceTitle(ScreenLockType.DEVTITANS));
        ...
        protected Intent getLockDevtitansIntent() {
        ...
        private Intent getIntentForUnlockMethod(int quality) {
            ...
            if (quality == DevicePolicyManager.PASSWORD_QUALITY_DEVTITANS){
                intent = getLockDevtitansIntent();
            }else if (quality >= DevicePolicyManager.PASSWORD_QUALITY_MANAGED) {
